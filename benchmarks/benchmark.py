...
from bitnet_triton import BitLinearTriton, pack_weights
...
def main():
    ...
    for batch_size, in_features, out_features in configs:
        ...
        try:
            ...
            print(f"{config_str:<25} {time_linear:>12.3f} {time_bitnet:>12.3f} {speedup:>10.2f}x {mem_ratio:>10.1f}x")
    ...
    print(f"Training vs Inference output difference:")
    ...
    print(f"  Ratio: {(in_features * out_features * 4) / (in_features * out_features * 2 / 8):.1f}x")
